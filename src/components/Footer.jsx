        ...
        for (let person of contactInfo[contactType]) {
            contactsList.push(
                person.phone !== '' ?
                    ...
                    :
                    <a key={person.name} className='ContactLink' href={'mailto:' + person.mail} target='_blank' rel="noreferrer">{person.name}<br />{person.mail}</a>
            );
        }
        ...
        <div className="Footer">
            <div className='FooterBody'>
                <div className='FooterCol'>
                    <div className='AlignCenter marginPaddingNone'><img className="FooterLogo" src={jmiLogo} alt="Jamia Logo" /></div>
                    <div className="ColHead AlignCenter marginPaddingNone">
                        Jamia Millia Islamia
                    </div>
                    <div className="RowHead AlignCenter marginPaddingNone">A Central University</div>
                    <a className='ContactLink AlignCenter' href='https://www.jmi.ac.in' target='_blank' rel="noreferrer">www.jmi.ac.in</a>
                </div>
                <div className='FooterCol'>
                    ...
                    <div className="ColBody">
                        <a className='ContactLink animateHover' href='mailto:dcs_plmt_mca@jmi.ac.in' target='_blank' rel="noreferrer">
                            <span>
                                <img className="RowIcon" src={emailIcon} alt="Email Icon" />
                            </span>
                            <span>dcs_plmt_mca@jmi.ac.in</span>
                        </a>
                        <a className='ContactLink animateHover' href='https://www.linkedin.com/company/mca-placement-cell/' target='_blank' rel="noreferrer">
                            <span>
                    ...
                    <Link className='ContactLink' to='/placement'>Placement</Link>
                    <Link className='ContactLink' to='/professors'>Professors</Link>
                    <Link className='ContactLink' to='/students'>Students</Link>
                    <Link className='ContactLink' to='/about'>About DCS</Link>
                </div>
                <div className='FooterCol'><div className="ColHead">
                    Contact
                </div>
                    <div className="ColBody">
                        {ContactsElement}
                ...
                <div className='FooterCol'><div className="ColHead">
                    ...
                    <div className="ColBody">
                        ...
                        <div className="RowContent">
                            Department of Computer Science, <br /> Maulana Mohammad Ali Jauhar Marg, <br /> Jamia Millia Islamia, <br /> Jamia Nagar, Okhla, New Delhi, Delhi-110025
                        </div>
                    </div>
                </div>
            </div>
